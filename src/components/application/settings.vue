<template>
  <div class="container" style="padding: 10px; font-family:'Open Sans', sans-serif !important;">
    ...
    <div class="row" style="margin-bottom: 0;">
      <div class="col l2 s1">
        <h4><i class="material-icons"
               title="Sets how frequently Plex Together will poll the client for new information.
                Most clients can handle multiple requests per second but mobile devices might not be able to handle the load. Default is 5000ms (5 seconds)">info_outline</i>
        </h4>
      </div>
      <div class="col l5 s11">
        <h4 style="padding-bottom: 10px; text-align: left;">Plex Client Polling Interval</h4>
      </div>
    ...
    <div class="row" style="margin-bottom: 0;">
      <div class="col l2 s1">
        <h4><i class="material-icons"
               title="Sets the acceptable distance away from the host in milliseconds. Syncs below 1500ms may be hard to achieve. Default is 3000ms(3 seconds).">info_outline</i>
        </h4>
      </div>
      <div class="col l5 s11">
        <h4 style="padding-bottom: 10px; text-align: left;">Sync Flexibility </h4>
      </div>
      <div class="col l3 s12">
        <form action="#" style="margin-top: -15px">
          <p class="range-field">
