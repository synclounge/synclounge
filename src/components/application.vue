  ...
  <div class="main-body mdc-typography" style="height: calc(100% - 64px);overflow-y:hidden">
    ...
    <div class="content row" style="margin-bottom: 0">
      <div class="row main-body" style="height: 100%; margin-bottom: 0">
        ...
        <div v-if="ptConnected && chosenClient" class="col l3 s12 no-padding" id="plexTogetherChat"
          ...
          <div class="mdc-permanent-drawer chatInterface" style="height:100%">
            ...
            <div style="height: 60%;  overflow-y: scroll; border-bottom: 1px solid rgba(0, 0, 0, 0.4)">
              <ul class="mdc-list mdc-list--two-line mdc-list--avatar-list two-line-avatar-text-icon-demo page-userlist"
                  v-for="user in ptUsers">
                <ptuser :object="user"></ptuser>
              </ul>
            </div>
            <div class="mdc-list-group"
                 style="overflow-y: auto; height: calc(40% - 64px); top: 110px; border-top: 1px solid 1px solid rgba(240,245,255,0.3)">
              <section>
              ...
              <div class="channel-textarea" style="margin:0;padding:0">
                <div class="channel-textarea-inner">
                  <div class="channel-textarea-upload">
                    <textarea rows="1" v-bind:placeholder="chatBoxMessage" style="height: auto; overflow-y: auto;"
                              v-on:keyup.enter="sendMessage()" v-model="messageToBeSent"></textarea>
                  </div>
                </div>
              </div>
            </div>
